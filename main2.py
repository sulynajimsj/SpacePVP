...
HEALTH_FONT = pygame.font.SysFont('Segoe UI', 30)
WINNER_FONT = pygame.font.SysFont('Segoe UI', 110)
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    ...
    red_health_text = HEALTH_FONT.render(
        "Red Health: " + str(red_health), 1, WHITE)
    yellow_health_text = HEALTH_FONT.render(
        "Yellow Health: " + str(yellow_health), 1, WHITE)
